...
class Collector(object):
    ...
    def model_selection_graphs(self):
        ...
        if len(articles) > 0:
            ...
            list_key_sets = [keys_set - second_graph_second_key_set - second_graph_extra_key_set, second_graph_extra_key_set | second_graph_second_key_set]
            list_key_sets_2 = []
            ...
            '''Make sure there's no need for classification anymore'''
            X, y = self.get_article_covariates(self.all_articles - articles, keys_set - first_graph_second_key_set)
            
            '''Combo!''' 
            ones, zeros = Util.zeros_and_ones(Logistic.model_, Logistic.coef_)
            first_graph_extra_key_set = self.get_sets(ones, zeros) #keys set
            
            list_key_sets = [keys_set - first_graph_second_key_set - first_graph_extra_key_set, first_graph_extra_key_set | first_graph_second_key_set]
            list_key_sets_1 = []
            ...
            graph1 = Graph(self.all_articles - articles, list_key_sets_1, self)#collector
